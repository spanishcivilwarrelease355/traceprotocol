# 🛡️ traceprotocol - Secure Your Network with Ease
...
5. **Open the Terminal**:
   Open your terminal application. You can usually find it in your system's application menu.

6. **Navigate to the Extracted Folder**:
   Use the `cd` command followed by the path to the extracted folder. For example:
   ```bash
   cd ~/Downloads/traceprotocol
   ```
